...
router.get('/online', users_controller_1.getOnlineUsers);
router.get('/by-role', users_controller_1.getUsersByRole);
router.get('/by-roles', users_controller_1.getUsersByRoles); // 🚀 Nueva ruta optimizada
