...
export declare const listMonthsSummary: (req: Request, res: Response) => Promise<void>;
export declare const listBugsBySpecificMonth: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const listBugsByMonth: (req: Request, res: Response) => Promise<void>;
