...
class RequirementAnalyzer {
     ...
     */
    validateGherkinStructure(huText) {
        const findings = [];
        ...
        scenarios.forEach((scenario, scenarioIndex) => {
            ...
            if (scenario.given.length === 0) {
                findings.push({
                    ...
                    suggestion: 'El DADO debe describir el contexto inicial: "Dado que [precondición del sistema]"',
                    severity: "high",
                ...
                if (givenText.length < 10) {
                    findings.push({
                        ...
                        suggestion: 'El DADO debe incluir contexto detallado: "Dado que el usuario está logueado Y tiene permisos de administrador"',
                        severity: "medium",
                        lineNumber: scenario.startLine,
                    });
                }
                ...
                if (foundActionVerb) {
                    ...
                    findings.push({
                        ...
                        suggestion: 'Mover acciones al CUANDO: DADO: precondiciones, CUANDO: acciones del usuario',
                        severity: "high",
                        lineNumber: scenario.startLine,
                    });
                }
            ...
            if (scenario.when.length === 0) {
                findings.push({
                    ...
                    suggestion: 'El CUANDO debe describir la acción del usuario: "Cuando [acción específica]"',
                    severity: "high",
                    lineNumber: scenario.startLine,
                });
            }
                ...
                if (whenText.length < 10) {
                    findings.push({
                        ...
                        suggestion: 'El CUANDO debe describir acciones claras: "Cuando presiono el botón guardar AND completo el formulario"',
                        severity: "medium",
                        lineNumber: scenario.startLine,
                    });
                }
                ...
                if (!actionVerbs.some((v) => whenText.includes(v))) {
                    findings.push({
                        ...
                        suggestion: 'Debe contener verbo de acción: "Cuando el sistema ejecuta...", "Cuando presiono...", "Cuando el usuario selecciona..."',
                        severity: "medium",
                        lineNumber: scenario.startLine,
                    });
                }
            ...
            if (scenario.then.length === 0) {
                findings.push({
                    ...
                    suggestion: 'El ENTONCES debe describir el resultado esperado: "Entonces [verificación/resultado observable]"',
                    severity: "high",
                    lineNumber: scenario.startLine,
                });
            }
                ...
                if (thenText.length < 10) {
                    findings.push({
                        ...
                        suggestion: 'El ENTONCES debe detallar verificaciones: "Entonces veo el mensaje de éxito Y el registro se guarda en BD"',
                        severity: "medium",
                        lineNumber: scenario.startLine,
                    });
                }
                ...
                if (foundActionVerb) {
                    ...
                    findings.push({
                        ...
                        suggestion: 'El ENTONCES debe verificar estado/resultados, no ejecutar acciones: "Entonces veo...", "Entonces se guarda..."',
                        severity: "high",
                        lineNumber: scenario.startLine,
                    });
                }
                ...
                if (!verifyKeywords.some((v) => thenText.includes(v))) {
                    findings.push({
                        ...
                        suggestion: 'Debe describir qué se ve/verifica: "Entonces veo el mensaje...", "Entonces aparece...", "Entonces se guarda en..."',
                        severity: "medium",
                        lineNumber: scenario.startLine,
                    });
                }
        ...
        lines.forEach((line, lineIndex) => {
            ...
            // Detectar palabras clave Gherkin
                ...
                if (currentScenario && currentKeyword) {
                    ...
                    if (content)
                        currentScenario[currentKeyword].push(content);
                }
            }
        });
     ...
     */
    getWordsContext(text, wordCount) {
     ...
     */
    getWordsAroundKeyword(text, keyword, totalWords) {
        const words = text.trim().split(/\s+/);
        const keywordIndex = words.findIndex(w => w.toLowerCase().includes(keyword.toLowerCase()));
        if (keywordIndex === -1)
            return this.getWordsContext(text, totalWords);
     ...
     */
    async enhanceWithOllama(huText, localFindings) {
...
Responde de forma clara y concisa.`;
        try {
            ...
            console.warn("[Ollama] No disponible - usando análisis local. Ejecuta: ollama run llama2-mini");
    ...
    generatePDFContent(result) {
        ...
        const isMediumSeverity = (f) => f.severity === "medium";
        return {
            content: [
                {
...
exports.default = RequirementAnalyzer;
//# sourceMappingURL=requirement-analyzer-mcp.js.map